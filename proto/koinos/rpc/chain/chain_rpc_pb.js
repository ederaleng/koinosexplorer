...
var koinos_rpc_rpc_pb = require('../../../koinos/rpc/rpc_pb.js');
goog.object.extend(proto, koinos_rpc_rpc_pb);
goog.exportSymbol('proto.koinos.rpc.chain.chain_request', null, global);
goog.exportSymbol('proto.koinos.rpc.chain.chain_request.RequestCase', null, global);
goog.exportSymbol('proto.koinos.rpc.chain.chain_response', null, global);
goog.exportSymbol('proto.koinos.rpc.chain.chain_response.ResponseCase', null, global);
goog.exportSymbol('proto.koinos.rpc.chain.get_account_nonce_request', null, global);
goog.exportSymbol('proto.koinos.rpc.chain.get_account_nonce_response', null, global);
goog.exportSymbol('proto.koinos.rpc.chain.get_account_rc_request', null, global);
goog.exportSymbol('proto.koinos.rpc.chain.get_account_rc_response', null, global);
goog.exportSymbol('proto.koinos.rpc.chain.get_chain_id_request', null, global);
goog.exportSymbol('proto.koinos.rpc.chain.get_chain_id_response', null, global);
goog.exportSymbol('proto.koinos.rpc.chain.get_fork_heads_request', null, global);
goog.exportSymbol('proto.koinos.rpc.chain.get_fork_heads_response', null, global);
goog.exportSymbol('proto.koinos.rpc.chain.get_head_info_request', null, global);
goog.exportSymbol('proto.koinos.rpc.chain.get_head_info_response', null, global);
goog.exportSymbol('proto.koinos.rpc.chain.get_resource_limits_request', null, global);
goog.exportSymbol('proto.koinos.rpc.chain.get_resource_limits_response', null, global);
goog.exportSymbol('proto.koinos.rpc.chain.read_contract_request', null, global);
goog.exportSymbol('proto.koinos.rpc.chain.read_contract_response', null, global);
goog.exportSymbol('proto.koinos.rpc.chain.submit_block_request', null, global);
goog.exportSymbol('proto.koinos.rpc.chain.submit_block_response', null, global);
goog.exportSymbol('proto.koinos.rpc.chain.submit_transaction_request', null, global);
goog.exportSymbol('proto.koinos.rpc.chain.submit_transaction_response', null, global);
/**
...
proto.koinos.rpc.chain.get_resource_limits_response.toObject = function(includeInstance, msg) {
  var f, obj = {
    resourceLimitData: (f = msg.getResourceLimitData()) && koinos_chain_chain_pb.resource_limit_data.toObject(includeInstance, f)
  };
...
proto.koinos.rpc.chain.chain_request.toObject = function(includeInstance, msg) {
  var f, obj = {
    reserved: (f = msg.getReserved()) && koinos_rpc_rpc_pb.reserved_rpc.toObject(includeInstance, f),
...
proto.koinos.rpc.chain.chain_request.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new koinos_rpc_rpc_pb.reserved_rpc;
      reader.readMessage(value,koinos_rpc_rpc_pb.reserved_rpc.deserializeBinaryFromReader);
...
proto.koinos.rpc.chain.chain_request.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      koinos_rpc_rpc_pb.reserved_rpc.serializeBinaryToWriter
    );
  }
...
proto.koinos.rpc.chain.chain_request.prototype.getReserved = function() {
  return /** @type{?proto.koinos.rpc.reserved_rpc} */ (
    jspb.Message.getWrapperField(this, koinos_rpc_rpc_pb.reserved_rpc, 1));
};
...
proto.koinos.rpc.chain.chain_response.toObject = function(includeInstance, msg) {
  var f, obj = {
    reserved: (f = msg.getReserved()) && koinos_rpc_rpc_pb.reserved_rpc.toObject(includeInstance, f),
    error: (f = msg.getError()) && koinos_rpc_rpc_pb.error_response.toObject(includeInstance, f),
...
proto.koinos.rpc.chain.chain_response.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new koinos_rpc_rpc_pb.error_response;
      reader.readMessage(value,koinos_rpc_rpc_pb.error_response.deserializeBinaryFromReader);
      msg.setError(value);
      break;
    case 3:
...
proto.koinos.rpc.chain.chain_response.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      koinos_rpc_rpc_pb.error_response.serializeBinaryToWriter
    );
  }
  f = message.getSubmitBlock();
  if (f != null) {
...
proto.koinos.rpc.chain.chain_response.prototype.getError = function() {
  return /** @type{?proto.koinos.rpc.error_response} */ (
    jspb.Message.getWrapperField(this, koinos_rpc_rpc_pb.error_response, 2));
};
...
goog.object.extend(exports, proto.koinos.rpc.chain);
